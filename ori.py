...
features = cleanamazondf2[['# of Reviews','Delivery option','Made by','Price','Prime or not','Questions','Stars','Stock']]
...
q_NB_SGD.field_names = ['Comparision', 'True possible rate', 'True negative rate', 'Model Accuracy']
q_NB_SGD.add_row(['NB', 
